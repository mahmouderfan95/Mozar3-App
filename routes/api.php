...
Route::group(['prefix' => 'services'],function () {
    ...
    Route::get("/check-appointment-date/{service_id}/{date}", [ServiceController::class, "checkAppointmentDate"]);
});
...
Route::group(['middleware' => 'verifyClientAuth'] , function(){
    ...
    Route::group(['middleware' => ['is_banned'],'prefix' => 'order'],function () {
        ...
        Route::post('save-order-services-rate/{transaction_id}', 'TransactionController@saveOrderServicesRate');
        ...
        Route::post('services/vendor-feedback', 'TransactionController@OrderServiceVendorFeedback');
...
Route::group(['prefix' => 'faq-categories'],function () {
    ...
    Route::get("show/{id}", [FaqCategoryController::class, "show"]);
});
