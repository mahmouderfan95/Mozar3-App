...
class CartProduct extends Pivot
{
    ...
    'vendor_id' , 'warehouse_id' , 'shipping_type_id' , 'shipping_fees' , 'total_weight' , 'has_line_shipping' , 'total_price','service_id','service_fields','appointment_date','appointment_time','unit_price'];
