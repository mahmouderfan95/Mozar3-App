            ...
            <div class="card" id="orderList">
                <div class="card-header  border-0">
                    <div class="d-flex align-items-center">
                        <!-- <h5 class="card-title mb-0 flex-grow-1">@lang('translation.today_orders')</h5> -->
                ...
                <div class="card-body border border-dashed border-end-0 border-start-0">
                    <form action="{{ route('vendor.service_orders.todayOrders') }}">
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-1 col-sm-4">
                                <div>
                                    <a href="{{ route('vendor.service_orders.todayOrders') }}" type="reset"
                            ...
                            <div class="col-xxl-1 col-sm-4">
                                <div>
                                    <a href="{{ route('vendor.service_orders.export', ['customer' => request()->get('customer'),'status' => request()->get('status'), 'code' => request()->get('code'), 'export_type' => 'todayOrders']) }}"
