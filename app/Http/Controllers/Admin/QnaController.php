...
class QnaController extends Controller
{
    ...
    public function create(){
        ...
        return view('admin.qna.create', compact("breadcrumbParent", "breadcrumbParentUrl","faqCategories"));
    }
    ...
    public function edit(int $id)
    {
        ...
        return view("admin.qna.edit", compact('qna', "breadcrumbParent", "breadcrumbParentUrl","faqCategories"));
    }
