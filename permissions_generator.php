...
return [
    ...
    [
        ...
        "module" => [
            "ar" => "طلبات الخدمات",
            "en" => "service transactions"
        ],
        "scope" => "sub-admin",
        "route" => ["admin.service_transactions.index", "admin.service_transactions.export"],
        "group" => "service-transactions",
    ],
    [
        "name" => [
            "ar" => " عرض الطلبات الفرعية",
        ...
        "scope" => "sub-admin",
        "route" => ["admin.service_transactions.sub_orders", "admin.service_transactions.sub_orders_export"],
        "group" => "service-transactions",
    ],
    [
        "name" => [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.service_transactions.canceled_orders", "admin.service_transactions.canceled_export"],
        "group" => "service-transactions",
    ],
    [
        "name" => [
        ...
        "scope" => "sub-admin",
        "route" => [
            "admin.get_service_order_status",
            "admin.service_transactions.show",
            "admin.service_transactions.invoice",
            "admin.service_transactions.pdf-invoice",
        ],
        "group" => "service-transactions",
    ],
    [
        ...
        "scope" => "sub-admin",
        "route" => [
            'admin.update_service_order_status',
            "admin.service_transactions.manage",
            "admin.service_transactions.update",
        ],
        "group" => "service-transactions",
    ],
    [
        ...
        "route" => [
            "admin.service_transactions.invoice",
            "admin.service_transactions.invoice.pdf"
        ],
        "group" => "service-transactions",
    ],
    [
        ...
        "scope" => "sub-admin",
        "route" => [
            "admin.service-tax-invoices.show",
            "admin.service-tax-invoices.print",
            "admin.service-order-tax-invoices.print",
            "admin.service-international-tax-invoices.show",
            "admin.service-international-tax-invoices.print",
        ],
        "group" => "service-transactions",
    ],
    [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.service_transactions.cancel", "admin.service_transactions.cancelOrder", "admin.service_transactions.refundOrder"],
        "group" => "service-transactions",
    ],
    [
        "name" => [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.service_carts.index"],
        "group" => "service-transactions",
    ],
    [
        "name" => [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.service_carts.show"],
        "group" => "service-transactions",
    ],
    [
        "name" => [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.service_carts.delete"],
        "group" => "service-transactions",
    ],
    ...
    [
        ...
        "route" => [
            ...
            "admin.admin.upload_service_images",
            "admin.services.get_fields"
        ],
        "group" => "services",
    ],
    [
        ...
        "route" => [
            "admin.services.show",
            "admin.services.print-barcode",
            "admin.services.approve",
            "admin.services.toggle-status",
            "admin.services.accept-update",
            "admin.services.refuse-update",
            "admin.services.delete-stock"
        ],
        "group" => "services",
    ],
    [
    ...
    [
        ...
        "scope" => "sub-admin",
        "route" => [
            "admin.post-harvest-services-departments.index",
            "admin.post-harvest-services-departments.show",
        ],
    ...
    [
        ...
        "scope" => "sub-admin",
        "route" => [
            "admin.post-harvest-services-departments.store",
            "admin.post-harvest-services-departments.create",
            "admin.post-harvest-services-departments.fields",
            "admin.post-harvest-services-departments.fields.create",
            "admin.post-harvest-services-departments.fields.store",
            "admin.post-harvest-services-departments.fields.edit",
            "admin.post-harvest-services-departments.fields.update",
            "admin.post-harvest-services-departments.fields.destroy"
    ...
    [
        ...
        "scope" => "sub-admin",
        "route" => [
            "admin.post-harvest-services-departments.update",
            "admin.post-harvest-services-departments.edit",
        ],
        "group" => "service-categories",
    ],
    [
        ...
        "scope" => "sub-admin",
        "route" => ["admin.post-harvest-services-departments.destroy"],
        "group" => "service-categories",
    ],
