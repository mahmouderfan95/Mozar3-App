...
class CreateServiceRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $additionalRules = [
            ...
            'appointment_time.*' => 'integer|distinct',
            'appointment_capacity' => 'required|array',
            'appointment_capacity.*' => 'integer|min:1',
    ...
    public function attributes()
    {
        ...
        $additionalAttributes = [
            ...
            "appointment_days" => __('translation.appointment_days'),
            "appointment_time" => __('translation.appointment_time'),
            "appointment_capacity" => __('translation.appointment_capacity'),
            "service_provider_phone" => __('translation.service_provider_phone'),
        ];
    ...
    {
        return [
            'service_provider_phone.digits' => 'رقم مقدم الخدمة يجب ان يحتوي على 10 أرقام فقط',
            'service_provider_phone.regex' => 'رقم مقدم الخدمة يجب ان يبدأ الحقل ب 05',
        ];
    }
}
