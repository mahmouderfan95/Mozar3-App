...
use App\Listeners\ServiceTransaction\Cancelled\CustomerListener;
use App\Listeners\ServiceTransaction\Created\AdminListener;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        ServiceTransactionEvents\Created::class => [
