                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarServiceOrders">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('vendor.service_orders.todayOrders') }}" class="nav-link">@lang('translation.today_orders')</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                            ...
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ route('vendor.reports.orders-report.index') }}"
                                        class="nav-link">@lang('reports.product-orders-report')</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('vendor.reports.service-orders-report.index') }}"
                                        class="nav-link">@lang('reports.service-orders-report')</a>
                                </li>
                            </ul>
                        </div>
                    </li>
