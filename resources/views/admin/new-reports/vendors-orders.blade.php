                            ...
                            <table class="table table-nowrap align-middle">
                                ...
                                @foreach($collection ?? [] as $row)
                                    <tr>
                                        ...
                                        <td> {{ $row->referenceOrder?->code ?? 'N/A' }} </td>
                                        <td> {{ $row->referenceOrder?->id  ?? 'N/A'}} </td>
                                        <td> {{ $row->created_at?->toDateString() }} </td>
                                        <td> {{ $row->referenceOrder?->delivered_at?->toDateString() }} </td>
                                        <td> {{ $row->referenceOrder?->sub_total_in_sar_rounded * 100 }} @lang("translation.sar") </td>
                                        <td> {{ $row->referenceOrder?->vat_in_sar_rounded  * 100}} @lang("translation.sar") ({{ $row->referenceOrder?->vat_percentage }}%) </td>
                                        <td> {{ $row->referenceOrder?->total_in_sar_rounded  * 100}} @lang("translation.sar") </td>
                                        <td> {{ $row->referenceOrder?->company_profit_without_vat_in_sar_rounded * 100 }} @lang("translation.sar") </td>
                                        <td> {{ $row->referenceOrder?->company_profit_vat_rate_rounded * 100 }} @lang("translation.sar") ({{ $row->referenceOrder?->vat_percentage }}%) </td>
                                        <td> {{ $row->referenceOrder?->company_profit_in_sar_rounded * 100 }} @lang("translation.sar") ({{ $row->referenceOrder?->company_percentage }}%)</td>
