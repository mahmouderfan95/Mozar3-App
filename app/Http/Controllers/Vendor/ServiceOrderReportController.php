...
use App\Services\Reports\ServiceOrdersReport;
...
class ServiceOrderReportController extends Controller
{
    public function __construct(
        private readonly ServiceOrdersReport $orderReportService
    ) {}
    ...
    public function index(Request $request) : View | RedirectResponse {
        ...
        // return $collection;
        return view("vendor.reports.vendors-service-orders", ['collection' => $collection ?? collect([])]);
    }
    ...
    public function print(Request $request) : View | RedirectResponse {
        ...
        if ($vendor) {
            try {
                ...
                return view(
                    "vendor.reports.print-vendors-service-orders",
