...
class SingleServiceResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $appointment_days = [];
        if(isset($this->appointment_days)){
            foreach ($this->appointment_days as $day) {
                $appointment_days[] = [
                    'day_number' => $day,
                    'day_name' => AppointmentDays::getStatus($day)
                ];
            }
        }
        ...
        return [
            ...
            'appointment_times' => ($this->timeAppointments) ? ServiceAppointmentResource::collection($this->timeAppointments) : null,
            'reviews' => ServiceReviewResource::collection($this->approvedReviews),
        ];
    }
}
