...
class ServiceController extends Controller
{
    ...
    public function create()
    {
        ...
        try {
            ...
            $appointmentDays = AppointmentDays::getDaysList();
            return view("admin.services.create", compact('vendors', "breadcrumbParent", "breadcrumbParentUrl","main_categories","cities","appointmentDays"));
        } catch (Exception $e) {
    ...
    public function edit($id)
    {
        try {
            ...
            $data['appointmentDays'] = AppointmentDays::getDaysList();
            if (isset($data['row'])) {
                $data['breadcrumbParent'] = 'admin.services.index';
                $data['breadcrumbParentUrl'] = route('admin.services.index');
