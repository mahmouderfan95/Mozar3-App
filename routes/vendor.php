...
use App\Http\Controllers\Vendor\ServiceOrderReportController;
...
Route::middleware(['vendor.auth', 'vendor.agreement-requested'])->group(function () {
    ...
    Route::get("service-orders/today/orders", [ServiceOrderController::class, "todayOrders"])->name('service_orders.todayOrders');
    ...
    Route::prefix('reports')
    ->middleware(['vendor_permission:reports'])
    ->controller(ServiceOrderReportController::class)
    ->group(function () {
        Route::get('service-orders-report', 'index')->name('reports.service-orders-report.index');
        Route::get('service-orders-report/print', 'print')->name('reports.service-orders-report.print');
        Route::get('service-orders-report/excel', 'excel')->name('reports.service-orders-report.excel');
    });
