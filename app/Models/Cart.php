...
class Cart extends BaseModel
{
    ...
    'total_shipping_fees' ,
    'total_weight' ,
    'visa_amount', 'wallet_amount', 'van_type' , 'products_count' , 'total_price' , 'guest_customer_id','service_address','service_date','type','appointment_data','appointment_time'];
    ...
    public function services()
    {
        ...
        ->using(CartProduct::class)->withPivot('quantity','created_at','updated_at','total_price','appointment_date','appointment_time');
    }
    ...
    public function getVendorCartVatTotalService($vendorId)
    {
        return $this->cartProducts
            ...
            ->sum(fn($c) => $c->quantity * ($c->unit_price ?? 0));
    }
