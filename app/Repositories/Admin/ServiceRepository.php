...
class ServiceRepository extends BaseRepository
{
    ...
    public function store_service($data_request)
    {
        ...
        if (isset($data_request['appointment_time']) && is_array($data_request['appointment_time']) &&
        isset($data_request['appointment_capacity']) && is_array($data_request['appointment_capacity'])) {

            $appointments = $data_request['appointment_time'];
            $capacities = $data_request['appointment_capacity'];
