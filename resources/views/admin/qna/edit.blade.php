                                ...
                                <div class="tab-content">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="choices-publish-status-input" class="form-label">@lang('admin.qnas.faq_categories')<span class="required"
                                                    style="color: red!important">*</span></label>
                                            <select class="form-select"
                                                name="faq_category_id" id="faq_category_id">
                                                <option value="" disabled>@lang('admin.qnas.faq_categories')</option>
                                                @foreach ($faqCategories as $faqCategory)
                                                    <option
                                                        @if ((isset($qna) && $qna->faq_category_id == $faqCategory->id) || old('faq_category_id') == $faqCategory->id) selected @endif value="{{ $faqCategory->id }}">
